  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-carbon relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-0 right-0 h-px bg-rainbow opacity-20" />
        <div className="absolute top-2/4 left-0 right-0 h-px bg-rainbow opacity-10" />
        <div className="absolute top-3/4 left-0 right-0 h-px bg-rainbow opacity-10" />
      </div>
      ...
      >
        {/* Neon top accent */}
        <div className="absolute top-0 left-0 right-0 h-0.5 bg-rainbow" />
        ...
        >
          {loading ? 'STARTING ENGINE...' : 'START RACE'}
        </button>
      </form>
    </div>
  );
